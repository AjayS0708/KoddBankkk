...
- [x] Restyled Dashboard to classic light banking theme with improved readability
...
- 2026-02-24: Dashboard restyled to a classic light UI with cleaner cards, spacing, and hierarchy.
